...
public class Player {
        private String location = "Queen's Garden";
                    ...
                    if (!nameNode.isMissingNode()) {  // if "name" node is not missing
                        ...
                        for (JsonNode node : nameNode) {
                            ...
                            if (locationNode.equals(node)) {
                                System.out.println("            *********  You are in the " + node.asText() + ". *********\n");
                                prompt();
                            }

                            //direction
                            if (!directionsNode.isMissingNode()) {
                                if (directionsNode.equals(node)) {
                                    ...
                                    for (JsonNode direction : directionsNode) {
                                        ...
                                        JsonNode upNode = node.path("up");
                                        JsonNode downNode = node.path("down");
                                        ...
                                        if (upNode.equals(direction)) {
                                            directionList.add("up");
                                        }
                                        if (downNode.equals(direction)) {
